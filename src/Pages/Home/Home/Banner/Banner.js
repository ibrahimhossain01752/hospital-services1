        ...
        <div class="carousel-item">
          ...
          {/* <div class="carousel-item active">
            ...
            <div class="carousel-caption d-none d-md-block">
              <h5 class="para1 ">Welcome to</h5>
             <h1 class="beauti-title"><span class="colec2">Oreo </span> <span class="colec">Hospital///////////</span></h1>
             <h5 class="para2">Contrary to popular belief, Lorem Ipsum is not simply random text.
